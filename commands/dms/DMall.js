...
class DMallCommand extends commando.Command {
    ...
    async run(message, args){
        ...
        const messagedmall = new Discord.RichEmbed()
	            .setColor('#145A32')
                .setAuthor('𝐆𝐫𝐞𝐞𝐧𝐖𝐢𝐜𝐡 𝐍𝐞𝐰𝐬', 'https://i.ibb.co/P4RnBCp/ezgif-com-video-to-gif-10-1.gif')
                .setDescription(`${msg}`)
                .setTimestamp()
	            .setFooter('𝐆𝐫𝐞𝐞𝐧𝐖𝐢𝐜𝐡 𝐍𝐞𝐰𝐬', 'https://i.ibb.co/P4RnBCp/ezgif-com-video-to-gif-10-1.gif');
